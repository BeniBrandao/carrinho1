...
function car1_up()
{
	...
	{
		car1Y = car1Y - 10;
		console.log("quando seta para cima e precionada, x ="+car1X+ " y = "+car1Y);
		uploadBackground();
uploadcar1();
uploadcar2();
	}
...
function car1_down()
{
	...
	{
		car1Y = car1Y - 10;
		console.log("quando seta para baixo e precionada, x ="+car1X+ " y = "+car1Y);
		uploadBackground();
uploadcar1();
uploadcar2();
	}
...
function car1_left()
{
	...
	{
		car1X = car1X - 10;
		console.log("quando seta para esquerda e precionada, x ="+car1X+ " y = "+car1Y);
		uploadBackground();
uploadcar1();
uploadcar2();
	}
...
function car1_right()
{
	...
	{
		car1X = car1X + 10;
		console.log("quando seta para direita e precionada, x ="+car1X+ " y = "+car1Y);
		uploadBackground();
uploadcar1();
uploadcar2();
	}
